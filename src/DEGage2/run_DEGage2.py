...
from . import DOTNB as DEGage2_DOTNB
...
def DOTNB(data, geneNames, group1, group2, DOTNB_thresh):
    ...
    #get log-2-fold-changes on DEG rows 
    lfc_list = params.calculate_log2_fold_change(data, group1)
...
def DEGage2_0(count_file, groups, optimizer_file = "NA" , DOTNB_thresh = -1.0 , perm_thresh = -1.0 , num_permutations = 1000):
    ...
    return (results_df) #return df of results 
